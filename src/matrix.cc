...
/*export*/ template <class T>
Matrix<T>::Matrix(const size_t rows, const size_t columns, T default_value) {
  m_matrix = nullptr;
...
/*export*/ template <class T>
void
Matrix<T>::resize(const size_t rows, const size_t columns, T default_value) {
